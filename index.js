...
client.on("message", msg => {
  ...
  if (msgLowercase.includes("anakin nut")) {
  ...
  } if (msgLowercase.includes("palpatine nut") || msgLowercase.includes("sucking")) {
    reply =
    ...
    reply = yodaNutGif;
  }else if (msgLowercase.includes("wise") || msgLowercase.includes("tragedy")) {
  ...
  } else if (msgLowercase.includes("kill") || msgLowercase.includes("power") || msgLowercase.includes("palp")){
    ...
    reply = "https://66.media.tumblr.com/750f96e135b0ce28a872efaaa2d4e88f/tumblr_inline_p6j4k3djkp1v75jbp_540.gif";
    ...
    reply =
      "https://media.giphy.com/media/HUVhRiUpOre6I/giphy.gif";
    ...
    reply = 
      "https://media.giphy.com/media/181OUQHOCfde0/giphy.gif";
  } else if (
